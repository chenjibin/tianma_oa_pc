    ...
    export default {
        ...
        methods: {
            ...
            _delQuestion(data) {
                ...
                sendData.id = data.id;
                this.$http.post('/questionnairepaper/delQuestion', sendData).then((res) => {
                    if (res.success) {
                        this._getPaperDetail();
            ...
            _getPaperDetail() {
                ...
                let sendData = {};
                sendData.id = this.id;
                sendData.questionnaire_id = this.id;
                this.$http.post('/questionnairepaper/editPaper', sendData).then((res) => {
                    if (res.success) {
